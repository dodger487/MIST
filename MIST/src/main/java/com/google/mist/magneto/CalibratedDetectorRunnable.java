 ...
 *
 *
 * Created by smus on 5/2/14.
 */
public class CalibratedDetectorRunnable implements Runnable, SensorEventListener {
  ...
  private MagnetPullDetector.MagnetPullListener mListener = null;

  public boolean mIsCalibrated = true;

  CalibratedDetectorRunnable(Context context) {
